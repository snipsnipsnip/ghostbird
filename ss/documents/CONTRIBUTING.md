...
\* If you don't like GitHub, we have mirrors on [Codeberg](https://codeberg.org/exteditor/ghostbird/) and [GitLab](https://gitlab.com/snipsnip/exteditor/ghostbird), although it may not be as up-to-date. Try pinging by raising an issue on one of those platforms.
