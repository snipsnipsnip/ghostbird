...
> **new EmailEditor**(`composeWindow`, `port`, `options`, `manifestInfo`): `EmailEditor`
...
[`ClientOptions`](../../ghosttext-runner/type-aliases/ClientOptions.md)

##### manifestInfo

[`IManifestInfo`](../interfaces/IManifestInfo.md)
...
> `readonly` **manifestInfo**: [`IManifestInfo`](../interfaces/IManifestInfo.md)
...
> `readonly` **options**: [`ClientOptions`](../../ghosttext-runner/type-aliases/ClientOptions.md)
...
Defined in: work/ghostbird/ghostbird/build/src/ghosttext-adaptor/email\_editor.d.ts:14
...
Defined in: work/ghostbird/ghostbird/build/src/ghosttext-adaptor/email\_editor.d.ts:13
